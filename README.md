...
1. **Cadastrar nova peça** — Insere uma peça com ID, peso, cor e comprimento. O sistema avalia e classifica automaticamente.
2. **Listar peças aprovadas/reprovadas** — Exibe todas as peças cadastradas separadas por status.
3. **Remover peça cadastrada** — Remove uma peça pelo ID.
4. **Listar caixas fechadas** — Mostra as caixas que atingiram 10 peças e a caixa atual.
5. **Gerar relatório final** — Exibe totais de aprovadas, reprovadas (com motivos) e caixas utilizadas.

## Como Rodar o Programa

### Pré-requisitos
- Python 3.6 ou superior instalado ([Download](https://www.python.org/downloads/))
...
2. Execute o programa:
   ...
   ```
3. O menu interativo será exibido no terminal. Digite o número da opção desejada.
